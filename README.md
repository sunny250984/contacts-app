# Contacts App
This project is code from coding along to Todd Motto's Ultimate Angular 1.x Pro course.

See -> [Ultimate Angular](https://ultimateangular.com) for a full list of available courses.
